/*@@
   ...
   @desc
            Creates the CCTK variables for thorn PUGHReduce
   @enddesc
 @@*/
...
#endif /* END SPEC */ 
#ifdef SPEC 
#include "PUGHReduce/cctk_Arguments.h" 
#else 
#include "PUGHReduce/cctk_Arguments.h"
#endif /* END SPEC */ 
...
static int CCTKi_BindingsFortranWrapperPUGHReduce(void *_GH, void *fpointer);
