...
static int CCTKi_BindingsFortranWrapperML_BSSN_Helper(void *_GH, void *fpointer);

static int CCTKi_BindingsFortranWrapperML_BSSN_Helper(void *_GH, void *fpointer)
{
  cGH const *const GH = _GH;
  const int _cctk_zero = 0;
  void (*function)(ML_BSSN_HELPER_C2F_PROTO);
  DECLARE_ML_BSSN_HELPER_C2F
  INITIALISE_ML_BSSN_HELPER_C2F
  (void) (_cctk_zero + 0);

  function = (void (*) (ML_BSSN_HELPER_C2F_PROTO)) fpointer;
  function (PASS_ML_BSSN_HELPER_C2F (GH));
...
int CactusBindingsVariables_ML_BSSN_Helper_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("ML_BSSN_Helper", CCTKi_BindingsFortranWrapperML_BSSN_Helper);
