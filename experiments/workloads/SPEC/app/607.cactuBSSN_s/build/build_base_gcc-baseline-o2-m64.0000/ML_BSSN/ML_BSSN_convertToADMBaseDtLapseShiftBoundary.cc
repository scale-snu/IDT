...
static void ML_BSSN_convertToADMBaseDtLapseShiftBoundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS
  DECLARE_CCTK_PARAMETERS
...
#endif
  CCTK_LOOP3(ML_BSSN_convertToADMBaseDtLapseShiftBoundary,
  ...
  CCTK_ENDLOOP3(ML_BSSN_convertToADMBaseDtLapseShiftBoundary);
}
