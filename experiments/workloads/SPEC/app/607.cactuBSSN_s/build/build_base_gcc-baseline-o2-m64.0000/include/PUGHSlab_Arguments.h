/*@@
   @header  PUGHSlab_Arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn PUGHSlab
   @enddesc
 @@*/
...
#define PASS_PUGHSLAB_PRIVATE_C2F(GH) \
...
#define PASS_PUGHSLAB_PROTECTED_C2F(GH) \
...
#define PASS_PUGHSLAB_PUBLIC_C2F(GH) \
...
#define PASS_PUGHSLAB_C2F(GH) _PASS_CCTK_C2F(GH)
