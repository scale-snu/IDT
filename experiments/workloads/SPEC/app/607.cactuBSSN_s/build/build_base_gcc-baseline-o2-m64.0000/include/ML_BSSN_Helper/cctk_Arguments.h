...
#include "ML_BSSN_Helper_Arguments.h"
...
#define CCTK_ARGUMENTS ML_BSSN_HELPER_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ML_BSSN_HELPER_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS ML_BSSN_HELPER_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_ML_BSSN_HELPER_FARGUMENTS
#endif

#define CCTK_FARGUMENTS ML_BSSN_HELPER_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_ML_BSSN_HELPER_FARGUMENTS
#define CCTK_CARGUMENTS ML_BSSN_HELPER_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_ML_BSSN_HELPER_CARGUMENTS
#endif
