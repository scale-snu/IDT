...
#define CCTK_ARGUMENTS GAUGEWAVE_CARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_CARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GAUGEWAVE_CARGUMENTS
#endif

#ifdef FCODE
#define CCTK_ARGUMENTS GAUGEWAVE_FARGUMENTS
#define _CCTK_ARGUMENTS _CCTK_FARGUMENTS
#define DECLARE_CCTK_ARGUMENTS DECLARE_GAUGEWAVE_FARGUMENTS
#endif

#define CCTK_FARGUMENTS GAUGEWAVE_FARGUMENTS
#define DECLARE_CCTK_FARGUMENTS DECLARE_GAUGEWAVE_FARGUMENTS
#define CCTK_CARGUMENTS GAUGEWAVE_CARGUMENTS
#define DECLARE_CCTK_CARGUMENTS DECLARE_GAUGEWAVE_CARGUMENTS
#endif
