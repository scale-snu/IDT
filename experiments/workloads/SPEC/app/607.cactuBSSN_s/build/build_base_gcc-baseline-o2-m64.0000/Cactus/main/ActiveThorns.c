 /*@@
   ...
   @enddesc
   @version   $Id: ActiveThorns.c 4986 2013-03-18 17:49:21Z sbrandt $
 @@*/
...
int CCTK_FCALL cctk_isthornactive (ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_isthorncompiled (int *retval, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_isimplementationcompiled (int *retval, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_isimplementationactive (int *retval, ONE_FORTSTRING_ARG);
#else
int CCTK_FCALL cctk_isthornactive_ (ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_isthorncompiled_ (int *retval, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_isimplementationcompiled_ (int *retval, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_isimplementationactive_ (int *retval, ONE_FORTSTRING_ARG);
#endif
...
#if defined(SPEC_NO_UNDERSCORE)
int CCTK_FCALL cctk_isthornactive
#else
...
#if defined(SPEC_NO_UNDERSCORE)
void CCTK_FCALL cctk_isthorncompiled
#else
...
#if defined(SPEC_NO_UNDERSCORE)
void CCTK_FCALL cctk_isimplementationcompiled
#else
...
#if defined(SPEC_NO_UNDERSCORE)
void CCTK_FCALL cctk_isimplementationactive
#else
