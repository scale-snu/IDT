...
!
#ifdef ESMF_LIB
        integer, parameter :: i1b= ESMF_KIND_I1                !  1-byte
        integer, parameter :: i2b= ESMF_KIND_I2                !  2-byte
        integer, parameter :: i4b= ESMF_KIND_I4                !  4-byte
        integer, parameter :: i8b= ESMF_KIND_I8                !  8-byte
