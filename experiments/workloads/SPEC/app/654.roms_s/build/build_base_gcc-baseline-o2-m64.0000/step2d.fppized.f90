...
!
!svn $Id: step2d_LF_AM3.h 381 2009-08-11 19:50:39Z arango $
!=======================================================================
!                                                                      !
...
!
      ...
      DO j=-2+MAX(2,JstrV-1),MIN(Jend+1,Mm(ng))+1
        ...
        END DO
      END DO
      DO j=-1+MAX(2,JstrV-1),MIN(Jend+1,Mm(ng))+1
        DO i=-2+IstrU-1,Iend+1+1
          cff=0.5_r8*om_v(i,j)
...
!
     ...
     &                      cff*(Dgrad(i,j)+Dgrad(i,j-1)))
        END DO
      END DO
      DO j=MAX(JstrV-1,2),MIN(Jend+1,Mm(ng))
        DO i=Istr,Iend
