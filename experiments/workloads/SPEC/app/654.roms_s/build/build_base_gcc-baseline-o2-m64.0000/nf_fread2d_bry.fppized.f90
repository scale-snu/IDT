...
!
!svn $Id: nf_fread2d_bry.F 395 2009-09-07 19:58:18Z arango $
!================================================== Hernan G. Arango ===
...
!
      bounded(iwest )=Istr.eq.1
      bounded(ieast )=Iend.eq.Lm(ng)
      bounded(isouth)=Jstr.eq.1
      bounded(inorth)=Jend.eq.Mm(ng)
!
