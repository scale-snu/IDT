...
!
!svn $Id: nf_fwrite4d.F 303 2009-01-26 22:49:13Z arango $
!================================================== Hernan G. Arango ===
...
!
        CALL mp_collect (ng, model, Npts, IniVal, Aout)
!
!  Remove land points.
!
        ic=0
...
!
        ...
        status=nf90_put_var(ncid, ncvarid, Aout(Istr:), start, total)
        nf_fwrite4d=status
      END IF
# endif
!
