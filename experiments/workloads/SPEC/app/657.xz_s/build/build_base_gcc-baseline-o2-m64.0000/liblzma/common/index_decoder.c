...
static lzma_ret
index_decode(lzma_coder *pcoder, lzma_allocator *allocator,
...
static void
index_decoder_end(lzma_coder *pcoder, lzma_allocator *allocator)
{
	struct lzma_coder_s* coder = pcoder;
...
static lzma_ret
index_decoder_memconfig(lzma_coder *pcoder, uint64_t *memusage,
...
static lzma_ret
index_decoder_reset(lzma_coder *pcoder, lzma_allocator *allocator,
