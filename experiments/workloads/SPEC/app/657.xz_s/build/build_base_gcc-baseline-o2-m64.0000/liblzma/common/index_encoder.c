...
static lzma_ret
index_encode(lzma_coder *pcoder,
...
static void
index_encoder_end(lzma_coder *pcoder, lzma_allocator *allocator)
{
	lzma_free(pcoder, allocator);
	return;
}


static void
index_encoder_reset(lzma_coder *pcoder, const lzma_index *i)
{
	struct lzma_coder_s* coder = pcoder;
