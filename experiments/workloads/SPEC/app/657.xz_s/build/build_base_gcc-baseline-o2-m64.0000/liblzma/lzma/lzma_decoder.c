...
static lzma_ret
lzma_decode(lzma_coder */*restrict*/ pcoder, lzma_dict *restrict dictptr,
...
static void
lzma_decoder_uncompressed(lzma_coder *pcoder, lzma_vli uncompressed_size)
{
...
static void
lzma_decoder_reset(lzma_coder *pcoder, const void *opt)
{
	struct lzma_coder_s* coder = pcoder;
