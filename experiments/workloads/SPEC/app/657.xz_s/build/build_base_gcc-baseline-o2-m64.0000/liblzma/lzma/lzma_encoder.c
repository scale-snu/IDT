...
static inline void
literal(lzma_coder *pcoder, lzma_mf *mf, uint32_t position)
{
...
static inline void
match(lzma_coder *pcoder, const uint32_t pos_state,
...
static inline void
rep_match(lzma_coder *pcoder, const uint32_t pos_state,
...
static void
encode_symbol(lzma_coder *pcoder, lzma_mf *mf,
...
static bool
encode_init(lzma_coder *pcoder, lzma_mf *mf)
{
	struct lzma_coder_s* coder = pcoder;
...
static void
encode_eopm(lzma_coder *pcoder, uint32_t position)
{
	struct lzma_coder_s* coder = pcoder;
	const uint32_t pos_state = position & coder->pos_mask;
...
extern lzma_ret
lzma_lzma_encode(lzma_coder */*restrict*/ pcoder, lzma_mf *restrict mf,
...
static lzma_ret
lzma_encode(lzma_coder */*restrict*/ pcoder, lzma_mf *restrict mf,
		uint8_t *restrict out, size_t *restrict out_pos,
		size_t out_size)
{
	struct lzma_coder_s* restrict coder = pcoder;
...
extern lzma_ret
lzma_lzma_encoder_reset(lzma_coder *pcoder, const lzma_options_lzma *options)
{
	struct lzma_coder_s* coder = pcoder;
		...
		const lzma_options_lzma *options, lzma_lz_options *lz_options)
{
	...
	struct lzma_coder_s *coder = *coder_ptr;
