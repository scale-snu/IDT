...
static inline uint32_t
get_short_rep_price(const lzma_coder *const pcoder,
...
static inline uint32_t
get_pure_rep_price(const lzma_coder *const pcoder, const uint32_t rep_index,
...
static inline uint32_t
get_rep_price(const lzma_coder *const pcoder, const uint32_t rep_index,
...
static inline uint32_t
get_pos_len_price(const lzma_coder *const pcoder, const uint32_t pos,
		const uint32_t len, const uint32_t pos_state)
{
	const struct lzma_coder_s *const coder = pcoder;
...
static void
fill_distances_prices(lzma_coder *pcoder)
{
...
static void
fill_align_prices(lzma_coder *pcoder)
{
	struct lzma_coder_s * coder = pcoder;
...
static void
backward(lzma_coder */*restrict*/ pcoder, uint32_t *restrict len_res,
...
static inline uint32_t
helper1(lzma_coder */*restrict*/ pcoder, lzma_mf *restrict mf,
