...
static void
copy_and_encode(lzma_coder *pcoder,
...
static void
encode_in_place(lzma_coder *pcoder, uint8_t *buffer, size_t size)
{
	struct lzma_coder_s* coder = pcoder;
	const size_t distance = coder->distance;
...
static lzma_ret
delta_encode(lzma_coder *pcoder, lzma_allocator *allocator,
...
static lzma_ret
delta_encoder_update(lzma_coder *pcoder, lzma_allocator *allocator,
